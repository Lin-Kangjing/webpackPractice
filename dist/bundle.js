...
__webpack_require__.e(/*! import() | test2 */ "test2").then(__webpack_require__.bind(__webpack_require__, /*! ./test2.js */ "./src/test2.js")).then(function (_ref) {
  var add = _ref.add;
  console.log(add(1, 2));
});
document.write('index.js'); // import './style.scss'
// write()
}();
/******/ })()
;
